#!/bin/bash
# Build script for vec-dotprod RISC-V vector benchmark
...
# Build vec-dotprod
echo "Building vec-dotprod..."
DOTPROD_SRCS="main.c dotproduct.c data.S"
OUTPUT="vec-dotprod.riscv"
${RISCV_GCC} ${INCLUDES} ${RISCV_GCC_OPTS} -o ${OUTPUT} \
    ${DOTPROD_SRCS} ${COMMON_SRCS} ${RISCV_LINK_OPTS}
