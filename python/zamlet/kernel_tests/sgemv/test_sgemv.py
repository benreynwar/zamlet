"""
Pytest tests for the sgemv kernel.
"""
...
def get_binaries():
    """Get list of sgemv binaries to test."""
    return [
        'vec-sgemv.riscv',
        'vec-sgemv-64x64.riscv',
        'vec-sgemv-large.riscv',
    ]
...
def test_sgemv(binary, params):
    """Run sgemv kernel and verify it passes."""
