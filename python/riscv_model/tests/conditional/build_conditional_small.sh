#!/bin/bash
# Build script for vec-conditional-small RISC-V vector benchmark
...
# Build vec-conditional-small
echo "Building vec-conditional-small..."
CONDITIONAL_SRCS="vec-conditional-small_main.c vec-conditional.S"
OUTPUT="vec-conditional-small.riscv"
