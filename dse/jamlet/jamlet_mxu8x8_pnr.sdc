...
puts "\[INFO] Setting JamletMxu PnR backward input delay to: $mxu_backward_input_delay_value"
set_input_delay $mxu_backward_input_delay_value -clock $clocks $mxu_backward_inputs

set mxu_backward_output_delay_pct 85
set mxu_backward_output_delay_value [expr $::env(CLOCK_PERIOD) * $mxu_backward_output_delay_pct / 100]
puts "\[INFO] Setting JamletMxu PnR backward output delay to: $mxu_backward_output_delay_value"
