...
PDK_FIELD_MAP = {
    ...
    "IO_PIN_H_LAYER": ("io_pin_h_layer", "string"),
    "IO_PIN_V_LAYER": ("io_pin_v_layer", "string"),
    ...
    "IO_PIN_H_LENGTH": ("io_pin_h_length", "number"),
    "IO_PIN_V_LENGTH": ("io_pin_v_length", "number"),
    "IO_PIN_MIN_DISTANCE": ("io_pin_min_distance", "number"),

    # Step-specific PDK variables - PDN (Power Distribution Network)
    "PDN_RAIL_LAYER": ("pdn_rail_layer", "string"),
    "PDN_RAIL_WIDTH": ("pdn_rail_width", "number"),
    "PDN_RAIL_OFFSET": ("pdn_rail_offset", "number"),
    "PDN_HORIZONTAL_LAYER": ("pdn_horizontal_layer", "string"),
    "PDN_VERTICAL_LAYER": ("pdn_vertical_layer", "string"),
    "PDN_CORE_HORIZONTAL_LAYER": ("pdn_core_horizontal_layer", "string"),
    "PDN_CORE_VERTICAL_LAYER": ("pdn_core_vertical_layer", "string"),
    "PDN_HOFFSET": ("pdn_hoffset", "number"),
    "PDN_VOFFSET": ("pdn_voffset", "number"),
    "PDN_HPITCH": ("pdn_hpitch", "number"),
    "PDN_VPITCH": ("pdn_vpitch", "number"),
    "PDN_HSPACING": ("pdn_hspacing", "number"),
    "PDN_VSPACING": ("pdn_vspacing", "number"),
    "PDN_HWIDTH": ("pdn_hwidth", "number"),
    "PDN_VWIDTH": ("pdn_vwidth", "number"),
    "PDN_CORE_RING_HOFFSET": ("pdn_core_ring_hoffset", "number"),
    "PDN_CORE_RING_VOFFSET": ("pdn_core_ring_voffset", "number"),
    "PDN_CORE_RING_HSPACING": ("pdn_core_ring_hspacing", "number"),
    "PDN_CORE_RING_VSPACING": ("pdn_core_ring_vspacing", "number"),
    "PDN_CORE_RING_HWIDTH": ("pdn_core_ring_hwidth", "number"),
    "PDN_CORE_RING_VWIDTH": ("pdn_core_ring_vwidth", "number"),
    "PDN_CORE_RING_CONNECT_TO_PADS": ("pdn_core_ring_connect_to_pads", "bool"),
    "PDN_CORE_RING_ALLOW_OUT_OF_DIE": ("pdn_core_ring_allow_out_of_die", "bool"),
    "PDN_EXTEND_TO": ("pdn_extend_to", "string"),
    "PDN_ENABLE_PINS": ("pdn_enable_pins", "bool"),
