...
def _init_impl(ctx):
    ...
    return [
        ...
        LibrelaneInput(
            ...
            linter_error_on_multidriven = _get_synth_val(ctx, synth_config, "linter_error_on_multidriven"),
            linter_defines = _get_synth_val(ctx, synth_config, "linter_defines"),
            linter_disable_warnings = _get_synth_val(ctx, synth_config, "linter_disable_warnings"),
            linter_disable_warnings_blackbox = _get_synth_val(ctx, synth_config, "linter_disable_warnings_blackbox"),
            linter_vlt = _get_synth_val(ctx, synth_config, "linter_vlt"),
            ...
            use_slang = _get_synth_val(ctx, synth_config, "use_slang"),
            slang_arguments = _get_synth_val(ctx, synth_config, "slang_arguments"),
            synth_clockgate_min_width = _get_synth_val(ctx, synth_config, "synth_clockgate_min_width"),
            synth_corner = _get_synth_val(ctx, synth_config, "synth_corner"),
            synth_show = _get_synth_val(ctx, synth_config, "synth_show"),
            ...
            synth_keep_hierarchy_min_cost = _get_synth_val(ctx, synth_config, "synth_keep_hierarchy_min_cost"),
            synth_keep_hierarchy_instances = _get_synth_val(ctx, synth_config, "synth_keep_hierarchy_instances"),
            synth_keep_hierarchy_modules = _get_synth_val(ctx, synth_config, "synth_keep_hierarchy_modules"),
            ...
            synth_normalize_single_bit_vectors = _get_synth_val(ctx, synth_config, "synth_normalize_single_bit_vectors"),
            ...
            io_pin_order_cfg = _get_pnr_val(ctx, pnr_config, "io_pin_order_cfg"),
            ...
            io_pin_v_extension = _get_pnr_val(ctx, pnr_config, "io_pin_v_extension"),
            io_pin_h_extension = _get_pnr_val(ctx, pnr_config, "io_pin_h_extension"),
            io_pin_v_thickness_mult = _get_pnr_val(ctx, pnr_config, "io_pin_v_thickness_mult"),
            io_pin_h_thickness_mult = _get_pnr_val(ctx, pnr_config, "io_pin_h_thickness_mult"),
            io_pin_placement_mode = _get_pnr_val(ctx, pnr_config, "io_pin_placement_mode"),
            errors_on_unmatched_io = _get_pnr_val(ctx, pnr_config, "errors_on_unmatched_io"),
            set_rc_verbose = _get_pnr_val(ctx, pnr_config, "set_rc_verbose"),
            pdn_skiptrim = _get_pnr_val(ctx, pnr_config, "pdn_skiptrim"),
            pdn_core_ring = _get_pnr_val(ctx, pnr_config, "pdn_core_ring"),
            pdn_enable_rails = _get_pnr_val(ctx, pnr_config, "pdn_enable_rails"),
            ...
            sta_extra_corner_tcl_file = _get_pnr_val(ctx, pnr_config, "sta_extra_corner_tcl_file"),
            deduplicate_corners = _get_pnr_val(ctx, pnr_config, "deduplicate_corners"),
            ...
            pl_keep_resize_below_overflow = _get_pnr_val(ctx, pnr_config, "pl_keep_resize_below_overflow"),
            pl_timing_driven = _get_pnr_val(ctx, pnr_config, "pl_timing_driven"),
            ...
            cts_balance_levels = _get_pnr_val(ctx, pnr_config, "cts_balance_levels"),
            cts_sink_buffer_max_cap_derate_pct = _get_pnr_val(ctx, pnr_config, "cts_sink_buffer_max_cap_derate_pct"),
            cts_delay_buffer_derate_pct = _get_pnr_val(ctx, pnr_config, "cts_delay_buffer_derate_pct"),
            cts_obstruction_aware = _get_pnr_val(ctx, pnr_config, "cts_obstruction_aware"),
            cts_sink_clustering_enable = _get_pnr_val(ctx, pnr_config, "cts_sink_clustering_enable"),
            cts_macro_clustering_size = _get_pnr_val(ctx, pnr_config, "cts_macro_clustering_size"),
            cts_macro_clustering_max_diameter = _get_pnr_val(ctx, pnr_config, "cts_macro_clustering_max_diameter"),
            ...
            cts_apply_ndr = _get_pnr_val(ctx, pnr_config, "cts_apply_ndr"),
            ...
            grt_antenna_repair_iters = _get_pnr_val(ctx, pnr_config, "grt_antenna_repair_iters"),
            grt_overflow_iters = _get_pnr_val(ctx, pnr_config, "grt_overflow_iters"),
            grt_antenna_repair_margin = _get_pnr_val(ctx, pnr_config, "grt_antenna_repair_margin"),
            grt_antenna_repair_jumper_only = _get_pnr_val(ctx, pnr_config, "grt_antenna_repair_jumper_only"),
            grt_antenna_repair_diode_only = _get_pnr_val(ctx, pnr_config, "grt_antenna_repair_diode_only"),
            drt_threads = _get_pnr_val(ctx, pnr_config, "drt_threads"),
            drt_opt_iters = _get_pnr_val(ctx, pnr_config, "drt_opt_iters"),
            drt_save_snapshots = _get_pnr_val(ctx, pnr_config, "drt_save_snapshots"),
            drt_antenna_repair_iters = _get_pnr_val(ctx, pnr_config, "drt_antenna_repair_iters"),
            drt_antenna_repair_margin = _get_pnr_val(ctx, pnr_config, "drt_antenna_repair_margin"),
            drt_antenna_repair_jumper_only = _get_pnr_val(ctx, pnr_config, "drt_antenna_repair_jumper_only"),
            drt_antenna_repair_diode_only = _get_pnr_val(ctx, pnr_config, "drt_antenna_repair_diode_only"),
            drt_save_drc_report_iters = _get_pnr_val(ctx, pnr_config, "drt_save_drc_report_iters"),
            non_default_rules = _get_pnr_val(ctx, pnr_config, "non_default_rules"),
            drt_assign_ndr = _get_pnr_val(ctx, pnr_config, "drt_assign_ndr"),
            ...
            pl_resizer_setup_gate_cloning = _get_pnr_val(ctx, pnr_config, "pl_resizer_setup_gate_cloning"),
            pl_resizer_setup_buffering = _get_pnr_val(ctx, pnr_config, "pl_resizer_setup_buffering"),
            pl_resizer_setup_buffer_removal = _get_pnr_val(ctx, pnr_config, "pl_resizer_setup_buffer_removal"),
            pl_resizer_setup_repair_tns_pct = _get_pnr_val(ctx, pnr_config, "pl_resizer_setup_repair_tns_pct"),
            pl_resizer_setup_max_util_pct = _get_pnr_val(ctx, pnr_config, "pl_resizer_setup_max_util_pct"),
            pl_resizer_hold_repair_tns_pct = _get_pnr_val(ctx, pnr_config, "pl_resizer_hold_repair_tns_pct"),
            pl_resizer_hold_max_util_pct = _get_pnr_val(ctx, pnr_config, "pl_resizer_hold_max_util_pct"),
            ...
            grt_resizer_setup_gate_cloning = _get_pnr_val(ctx, pnr_config, "grt_resizer_setup_gate_cloning"),
            grt_resizer_run_grt = _get_pnr_val(ctx, pnr_config, "grt_resizer_run_grt"),
            grt_resizer_setup_buffering = _get_pnr_val(ctx, pnr_config, "grt_resizer_setup_buffering"),
            grt_resizer_setup_buffer_removal = _get_pnr_val(ctx, pnr_config, "grt_resizer_setup_buffer_removal"),
            grt_resizer_setup_repair_tns_pct = _get_pnr_val(ctx, pnr_config, "grt_resizer_setup_repair_tns_pct"),
            grt_resizer_setup_max_util_pct = _get_pnr_val(ctx, pnr_config, "grt_resizer_setup_max_util_pct"),
            grt_resizer_hold_repair_tns_pct = _get_pnr_val(ctx, pnr_config, "grt_resizer_hold_repair_tns_pct"),
            grt_resizer_hold_max_util_pct = _get_pnr_val(ctx, pnr_config, "grt_resizer_hold_max_util_pct"),
            ...
            magic_gds_flatglob = _get_signoff_val(ctx, signoff_config, "magic_gds_flatglob"),
            magic_drc_maglefs = _get_signoff_val(ctx, signoff_config, "magic_drc_maglefs"),
            run_magic_drc = _get_signoff_val(ctx, signoff_config, "run_magic_drc"),
            klayout_conflict_resolution = _get_signoff_val(ctx, signoff_config, "klayout_conflict_resolution"),
            ...
            lvs_ignore_cells = _get_signoff_val(ctx, signoff_config, "lvs_ignore_cells"),
