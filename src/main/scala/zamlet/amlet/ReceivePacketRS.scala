 ...
 */
class ReceivePacketRS(params: AmletParams) extends ReservationStation[PacketInstr.ReceiveResolving, PacketInstr.ReceiveResolved](params, params.getReceivePacketRSParams(), new PacketInstr.ReceiveResolving(params), new PacketInstr.ReceiveResolved(params)) {
...
/** Generator object for creating ReceivePacketRS modules from command line arguments.
  ...
  */
object ReceivePacketRSGenerator extends zamlet.ModuleGenerator {
