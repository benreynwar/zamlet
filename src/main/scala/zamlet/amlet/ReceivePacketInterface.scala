...
class ReceivePacketInterface(params: AmletParams) extends Module {
  ...
  withReset(resetBuffered) {
    ...
    val forwardDirection = PacketRouting.calculateNextDirection(params, thisXBuffered, thisYBuffered, bufferedInstr.bits.xTarget, bufferedInstr.bits.yTarget)
 ...
 */
object ReceivePacketInterfaceGenerator extends zamlet.ModuleGenerator {
