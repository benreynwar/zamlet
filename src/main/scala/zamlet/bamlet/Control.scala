...
import zamlet.amlet.{ControlWrite, ControlWriteMode, ControlInstr, PredicateInstr, VLIWInstr}
...
class Control(params: BamletParams) extends Module {
  ...
  val instrBuffer = Module(new zamlet.utils.SkidBuffer(new VLIWInstr.Expanded(params.amlet)))
...
/** Generator object for creating Control modules from command line arguments.
  ...
  */
object ControlGenerator extends zamlet.ModuleGenerator {
