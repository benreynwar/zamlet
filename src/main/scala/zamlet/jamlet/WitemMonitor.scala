...
object WitemMonitorUtils {
  def coordsToVwIndex(params: ZamletParams, wordOrder: WordOrder.Type, x: UInt, y: UInt): UInt = {
  ...
  def elementsInVlineMask(params: ZamletParams, ewCode: EwCode.Type): UInt = {
  ...
  def vwIndexToCoords(params: ZamletParams, wordOrder: WordOrder.Type, vwIndex: UInt): (UInt, UInt) = {
...
class S11StridedIndexedState(params: ZamletParams) extends Bundle {
  val iterating = Bool()
...
class S11J2JState(params: ZamletParams) extends Bundle {
...
class S11J2JResult(params: ZamletParams) extends Bundle {
...
class S11StridedIndexedResult(params: ZamletParams) extends Bundle {
  val output = new S12S13Reg(params)
...
class CandidateSelect(params: ZamletParams) extends Bundle {
  val idx = UInt(log2Ceil(params.witemTableDepth).W)
  val prio = UInt(log2Ceil(params.witemTableDepth).W)
  val valid = Bool()
}

class S1S2Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
}

class S2S3Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
}

class S3S4Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
...
class S4S5Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val witemInfo = new WitemInfoResp(params)
...
class S5S6Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val witemInfo = new WitemInfoResp(params)
...
class S6S7Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val witemInfo = new WitemInfoResp(params)
...
class S7S8Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val witemInfo = new WitemInfoResp(params)
...
class S8S9Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val witemInfo = new WitemInfoResp(params)
...
class S10S11Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val witemInfo = new WitemInfoResp(params)
...
class S12S13Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val witemInfo = new WitemInfoResp(params)
...
class S13S14Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val witemInfo = new WitemInfoResp(params)
...
class S14S15Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val srcTag = UInt(log2Ceil(params.wordBytes).W)
...
class S15S16Reg(params: ZamletParams) extends Bundle {
  val entryIndex = UInt(log2Ceil(params.witemTableDepth).W)
  val instrIdent = params.ident()
  val witemType = WitemType()
  val srcTag = UInt(log2Ceil(params.wordBytes).W)
...
class WitemMonitor(params: ZamletParams) extends Module {
  ...
  val log2PageBytes = params.log2PageBytesPerZamlet
