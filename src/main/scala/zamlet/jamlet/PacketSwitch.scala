 ...
 * Packet Switch IO
 */
class PacketSwitchIO(params: ZamletParams) extends Bundle {
  // Current position
 ...
 */
class PacketSwitch(params: ZamletParams) extends Module {
 ...
 */
object PacketSwitchGenerator extends zamlet.ModuleGenerator {
